export default function ContrattiLoading() {
  return (
    <div className="min-h-screen bg-[#0e131f] text-[#dde2f3]">
      ...
      <div className="ml-[240px] min-h-screen flex flex-col">
        ...
        <main className="flex-1 p-8 max-w-[1280px] w-full">
          <div className="h-7 w-32 bg-[#1a202c] rounded-lg mb-2 animate-pulse" />
          <div className="h-4 w-72 bg-[#1a202c] rounded mb-8 animate-pulse" />
          <div className="grid grid-cols-2 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-[#1a202c] border border-[#3c4a42] rounded-xl h-44 animate-pulse" />
            ))}
          </div>
        </main>
      </div>
